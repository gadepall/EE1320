...
\title{ 
	\logo{Analog Operations through Arduino
	}
}
%\title{
...
%\maketitle
\begin{abstract}
This manual shows how to use an arduino for measuring an unknown resistance by interfacing with a simple voltage divider circuit.  This helps understand how to use the analog pins of the arduino.  The principle can be readily applied for reading sensor data.
\end{abstract}
\section{Components}
